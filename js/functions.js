...
function getMoveName(playerInput){
	if (playerInput == 1) {return  "kamień"} else {
...
function displayResults(argComputerMove, argplayerInput) {
	...
	if (argComputerMove == "kamień" && argplayerInput == "papier") {
		printMessage("Ty wygrałeś")} else {
			if (argComputerMove == "kamień" && argplayerInput == "nożyce") {
				printMessage("Teraz ja wygrałem")} else {
					if (argComputerMove == "kamień" && argplayerInput =="kamień") {
						printMessage("Remis")} else {
							if (argComputerMove == "papier" && argplayerInput == "kamień") {
								printMessage("Teraz ja wygrałem")} else {
									if (argComputerMove =="papier" && argplayerInput == "nożyce") {
										printMessage("Ty wygrywasz")} else {
											if (argComputerMove == "papier" && argplayerInput == "papier") {
												printMessage("Remis")} else {
													if (argComputerMove == "nożyce" && argplayerInput == "kamień") {
														printMessage("Ty wygrywasz")} else {
															if (argComputerMove == "nożyce" && argplayerInput == "nożyce") {
																printMessage("Remis")} else {
